...
import {
  ...
  Button, Select, MenuItem as MuiMenuItem, FormControl, InputLabel, Alert, Chip
} from '@mui/material';
...
export function LeadsListView() {
  ...
  const fetchLeads = useCallback(
    async (page = table.page, rowsPerPage = table.rowsPerPage, searchTerm = search) => {
      try {
        setLoading(true);
        const response = await axiosInstance.get(endpoints.user.allLeads, {
          params: {
            page: page + 1,
  ...
  const handleSearch = (e) => {
    ...
    fetchLeads(0, table.rowsPerPage, value);
  };
...
function LeadTableRow({ row, onFollowUp, onReferred }) {
